...
enum class Option
{
  ...
  PP_FDP_ENABLE,                   // bool
  PP_FDP_DUMP_PREFIX,              // str
  PP_FDP_NODE_ID,                  // numeric
  PP_FDP_NEXT_ID,                  // numeric
  PP_FDP_PARTI_SEED,               // numeric
...
class Options
{
 ...
 public:
  ...
  OptionBool pp_fdp_enable;
  OptionStr pp_fdp_dump_prefix;
  OptionNumeric pp_fdp_node_id;
  OptionNumeric pp_fdp_next_id;
  OptionNumeric pp_fdp_parti_seed;
